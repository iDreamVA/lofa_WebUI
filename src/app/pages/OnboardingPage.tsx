    ...
    <div className="min-h-screen bg-gradient-to-br from-[#fffef5] to-[#f0ede0] dark:from-gray-900 dark:to-gray-950 p-4 md:p-6 flex items-center justify-center">
      ...
      >
        ...
        <motion.div
          ...
          className="bg-white dark:bg-gray-800 rounded-2xl p-6 md:p-8 shadow-lg space-y-6 md:space-y-8"
        >
          {/* Name Input */}
          <div>
            <label className="block text-sm md:text-base font-semibold text-gray-900 dark:text-gray-100 mb-3">
              Your Name
            </label>
            <input
              type="text"
          ...
          {/* Gender Selection */}
          <div>
            <label className="block text-base md:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">{t.onboarding.gender}</label>
