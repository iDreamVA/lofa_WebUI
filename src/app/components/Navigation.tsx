...
export function Navigation() {
  ...
  return (
    <nav className="bg-[#fffef5] border-b border-gray-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <h1 className="text-lg md:text-2xl font-bold bg-gradient-to-r from-[#51553a] via-[#7a8a45] to-[#a0b868] bg-clip-text text-transparent" style={{ fontFamily: "'Playfair Display', serif" }}>
              {t.appTitle}
            </h1>
          </div>
                  ...
                  className={({ isActive }) =>
                    `flex items-center gap-2 px-3 lg:px-4 py-2 rounded-lg transition-colors text-sm lg:text-base ${
                      isActive
                        ...
                        : 'text-gray-600 hover:text-[#51553a] hover:bg-gray-50'
                    }`
                  }
                >
